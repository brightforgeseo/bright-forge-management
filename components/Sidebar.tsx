        ...
        <div className="relative">
          ...
          {isNotificationsOpen && (
            <>
              ...
              <div className="absolute top-full left-full ml-2 w-80 lg:w-96 bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden z-[70] text-slate-900 max-h-[calc(100vh-6rem)]">
