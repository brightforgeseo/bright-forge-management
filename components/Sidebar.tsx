        ...
        <div className="relative">
          ...
          {isNotificationsOpen && (
            <>
              ...
              <div className="fixed top-20 right-4 w-[calc(100vw-2rem)] md:w-96 bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden z-[70] text-slate-900 max-h-[calc(100vh-6rem)]">
