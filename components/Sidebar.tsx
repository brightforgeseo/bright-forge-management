        ...
        <div className="relative">
          ...
          {isNotificationsOpen && (
            <>
              ...
              <div className="fixed top-16 left-0 right-0 md:fixed md:top-16 md:left-auto md:right-4 w-full md:w-96 mt-0 md:mt-2 bg-white rounded-none md:rounded-xl shadow-xl border-t md:border border-slate-200 overflow-hidden z-50 text-slate-900 max-h-[calc(100vh-4rem)] md:max-h-[600px]">
