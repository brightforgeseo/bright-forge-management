    ...
    return (
      <div className="min-h-screen bg-portal-dark flex items-center justify-center">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-portal-accent border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-portal-soft">Loading...</p>
        </div>
      </div>
    );
  }
